...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top"
		id="mainNav">
		<a class="navbar-brand" href="User_Proparty.jsp"><b>${fname} ${lname}</b></a>
			...
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Dashboard"><a class="nav-link" href="index.html"> <i
						class="fa fa-fw fa-dashboard"></i> <span class="nav-link-text">Criminal Details</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Charts"><a class="nav-link" href="Missing_Record.jsp"> <i
						class="fa fa-fw fa-file"></i> <span class="nav-link-text">Missing Report</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link" href="Theft_Record.jsp"> <i
						class="fa fa-fw fa-file"></i> <span class="nav-link-text">Theft Report</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Tables"><a class="nav-link" href="FIR_Record.jsp"> <i
						class="fa fa-fw fa-file"></i> <span class="nav-link-text">FIR Report</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Components"><a
					class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
					href="#collapseComponents" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-table"></i> <span class="nav-link-text">View Registered Report</span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseComponents">
						<li><a href="Missing_Search.jsp">Missing Record</a></li>
						<li><a href="Theft_Search.jsp">Theft Report</a></li>
						<li><a href="cards.html">FIR Report</a></li>
					</ul></li>
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					...
					href="#collapseExamplePages" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-wrench"></i> <span class="nav-link-text">Update/Delete Report
							</span>
				</a>
					<ul class="sidenav-second-level collapse" id="collapseExamplePages">
						<li><a href="login.html">Missing Report</a></li>
						<li><a href="register.html">Theft Report</a></li>
						<li><a href="forgot-password.html">FIR Report</a></li>
					</ul></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Menu Levels"><a
					class="nav-link nav-link-collapse collapsed" data-toggle="collapse"
					href="#collapseMulti" data-parent="#exampleAccordion"> <i
						class="fa fa-fw fa-sitemap"></i> <span class="nav-link-text">User
							Levels</span>
				</a>
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div class="modal-body"><b>${fname} ${lname}</b><br>Select "Logout" below if you are
